...
#yum clean metadata
yum update -y
yum install -y amazon-efs-utils zsh
...
useradd --home-dir /efs/cattelan --shell /bin/zsh --uid 7001 --gid 7001 -G wheel --password $(openssl passwd -1 cattelan) cattelan || true
